  ...
  <div class="content_box1">
    ...
    >
      ...
      <el-table-column prop="orderStatus" label="订单状态" :formatter="stateFormat"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.$axios({
        method: "get",
        url: "/store/order/getHotProductOrderList/?orgId=" + this.orgId+'&orderStatus='+this.orderStatus+"&startTime="+this.startTime+'&endTime='+this.endTime,
