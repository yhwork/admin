<template>
  <div class="home">
    ...
    <div class="mask_box" v-if="mask_state">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="popup_box">
          ...
          <div v-if="orgType==0">
            <div>
              ...
              <el-form-item label="法人证件： " prop="positive">
                <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                  :on-success="uploadPositive" :headers="headers" :before-upload="beforeAvatarUpload">
              ...
              <el-form-item label="法人证件： " prop="back">
                <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                  :on-success="uploadBack" :headers="headers" :before-upload="beforeAvatarUpload">
              ...
              <el-form-item label="证件有效期：" prop="startTime">
                <el-date-picker v-model="ruleForm.startTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"
                  @change="getLicencesDate"></el-date-picker>
                <span v-if="!licences_checked">至</span>
                <el-date-picker v-model="ruleForm.endTime" type="date" placeholder="选择日期" v-if="!licences_checked"
                  value-format="yyyy-MM-dd" @change="getLicencesDate1"></el-date-picker>
          ...
          <div v-else-if="orgType==1">
            <div>
              ...
              <el-form-item label="身份证有效期：" prop>
                <el-date-picker v-model="ruleForm.startTime1" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"
                  @change="getidcardDate"></el-date-picker>
                <span v-if="!licences_checked">至</span>
                <el-date-picker v-model="ruleForm.endTime1" type="date" placeholder="选择日期" v-if="!licences_checked"
                  value-format="yyyy-MM-dd" @change="getidcardDate1"></el-date-picker>
                <el-checkbox v-model="licences_checked" @change="licences_change">长期</el-checkbox>
              </el-form-item>
              <el-form-item label="证件照： " prop="holdIdcard">
                <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                  :on-success="uploadHoldIdcard" :headers="headers" :before-upload="beforeAvatarUpload">
          ...
          <div v-else>
            <div>
              ...
              <el-form-item label="企业证件： " prop="ngoImg">
                <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                  :on-success="uploadNgoImg" :headers="headers" :before-upload="beforeAvatarUpload">
        ...
        <div v-else-if="active==1">
          <div v-if="orgType==0">
            <div>
              ...
              <el-form-item label="企业法人：" prop="legal_person">
                <el-input v-model="ruleForm.legal_person" placeholder="请输入企业法人姓名" disabled="disabled"></el-input>
              </el-form-item>
              <el-form-item label="营业执照号：" prop="license_num">
            ...
            <div>
              ...
              <el-form-item label="开户银行：" prop="bankName">
                <el-select v-model="ruleForm.bankName" @change="changeBank" placeholder="请选择">
                  <el-option v-for="item in bankList" :label="item.bankName" :key="item.bankId" :value="item.bankId">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="开户支行：" prop="name">
                <el-select v-model="ruleForm.name" value-key="code" placeholder="请选择" @change="changeCity">
                ...
                <el-select v-model="value" placeholder="请选择" value-key="subBranchId" @change="changeSubBank">
                  <el-option v-for="item in banksListByCity" :key="item.subBranchId" :label="item.subBranchName"
                    :value="item.subBranchId"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="开户许可证：" prop="openingPermit">
                <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                  :on-success="uploadPermit" :headers="headers" :before-upload="beforeAvatarUpload">
        ...
        <div v-else-if="active==2" style="margin-top:20px">
          ...
          <el-form-item label="门店 logo： " prop="logo">
            <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
              :on-success="uploadlogo" :headers="headers" :before-upload="beforeAvatarUpload">
          ...
          <el-form-item label="短信验证码：" prop="veryify_code">
            <div class="input_box">
              ...
              <el-button :plain="true" v-if="btnTitle" class="ml" @click="getVerificationCode()" :disabled="code_state">
                {{btnTitle}}</el-button>
            </div>
          ...
          <div v-if="veryifyType">
            ...
            <el-form-item label="加盟授权书： " prop="joinImg">
              <el-upload class="upload_box1" action="/store/file/img/upload" :show-file-list="false"
                :on-success="uploadJoinImg" :headers="headers" :before-upload="beforeAvatarUpload">
          ...
          <div>
            <baidu-map class="map" id="mapID" center="上海市" :zoom="zoom" :scroll-wheel-zoom="true" @click="getMarker"
        ...
        <div v-if="next_state">
          <el-button v-if="active==1||active==2||active==3" style="margin-top: 12px;" @click="prev">上一步</el-button>
        </div>

        <el-button style="margin-top: 12px;" type="primary" v-if="active==0||active==1" @click="submitForm('ruleForm')">
          下一步</el-button>

        <el-button type="primary" v-if="active==2" style="margin-top: 12px;" @click="submitForm('ruleForm')">提交认证
        </el-button>

        <div v-if="next_state">
          <el-button type="primary" v-if="active==3" style="margin-top: 12px;" @click="submitForm('ruleForm')">完成
          </el-button>
        </div>
      </el-form>
    </div>
